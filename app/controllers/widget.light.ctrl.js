...
(function () {
    angular
            .module('zcloud')
            .controller('WidgetLightController', ['$scope', 'Devices',
                WidgetLightController
            ]);
    function WidgetLightController($scope, Devices) {
        var vm = this;
        var chart;
        ...
        $scope.$on('DEVICE_DATA_UPDATE_' + vm.widget.device_id, function (event, data) {
            ...
            document.getElementById(vm.valueid).innerHTML = 'Light: ' + vm.deviceValue.toString() + ' lux';
        ...
        Devices.get(vm.widget.device_id, function (device) {
            ...
            Devices.history(limit - 1, vm.widget.device_id, function (history) {
                console.log("History light:", history);
